...
# https://rawhubusercontent.com/ailaby/ailaby-comfyui/main/config/provisioning/default.sh
...
CHECKPOINT_MODELS=(
    ...
    "https://huggingface.co/antonhugs/latest/resolve/main/albedobaseXL_v20.safetensors"
